...
controller: HeadingController,
  ...
  void optionsonclick(BuildContext context){
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text(notesProvider.notes[index].title! ,style: TextStyle(fontSize: 28 , color: Colors.white), overflow: TextOverflow.ellipsis,maxLines: 2,),
                SizedBox(height: 7,),
